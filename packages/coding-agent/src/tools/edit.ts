...
import { applyPatch } from "../patch/applicator";
import { generateDiffString, generateUnifiedDiffString, replaceText } from "../patch/diff";
import { findMatch } from "../patch/fuzzy";
import {
	applyHashlineEdits,
	computeLineHash,
	type HashlineEdit,
...
import { detectLineEnding, normalizeToLF, restoreLineEndings, stripBom } from "../patch/normalize";
import { buildNormativeUpdateInput } from "../patch/normative";
import { type EditToolDetails, getLspBatchRequest } from "../patch/shared";
import type { FileSystem, Operation, PatchInput } from "../patch/types";
import { EditMatchError } from "../patch/types";
